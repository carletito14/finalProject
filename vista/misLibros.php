...
$cliente = Persona::getPersonaById($idUsuario);
$cliente = $cliente->getLibrosComprados();
...
<body>
    <div class="container">
        <div class="d-flex justify-content-center">
            ...
            <h3><?php 
                echo $nombre ?> &nbsp&nbsp&nbsp<span class="badge badge-secondary">Código -><?php echo $idUsuario ?></span></h3>
        </div>
    </div>
